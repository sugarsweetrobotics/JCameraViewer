...
/*!
 * @class CameraViewerComp
 * @brief Standalone component Class
 *
 */
public class CameraViewerComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(CameraViewer.component_conf);
      mgr.registerFactory(prop, new CameraViewer(), new CameraViewer());

      // Create a component
      RTObject_impl comp = mgr.createComponent("CameraViewer");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        CameraViewerComp init = new CameraViewerComp();
